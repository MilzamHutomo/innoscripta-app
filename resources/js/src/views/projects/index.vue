...
import GridSkletion from "../../components/Skeleton/Project-grid.vue";
import TableSkeltion from "../../components/Skeleton/Table.vue";
import { computed, ref, watch, onMounted } from "vue";
import ProjectAddmodal from "./AddProject.vue";
import updateModal from "./EditProject.vue";
